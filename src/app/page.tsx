    ...
    <div>
      <div className="mb-10">
        ...
        <p className="text-neutral-400">
          Community-curated collection of memorable scenes. Know a great one?{" "}
          <a href="/submit" className="text-yellow-400 hover:underline">
            Submit it.
          </a>
        </p>
      </div>
      ...
      {videos.length === 0 ? (
        <div className="text-center py-24 text-neutral-600">
          ...
          <p className="mb-6">Be the first to submit a memorable movie scene.</p>
          <a
            href="/submit"
